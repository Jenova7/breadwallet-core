 ...
 * Signature: ()[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_electraproject_core_BRCorePaymentProtocolPayment_getMerchantData
  (JNIEnv *, jobject);
 ...
 */
JNIEXPORT jstring JNICALL Java_com_electraproject_core_BRCorePaymentProtocolPayment_getMerchantMemo
  (JNIEnv *, jobject);
 ...
 * Signature: ([B)J
 */
JNIEXPORT jlong JNICALL Java_com_electraproject_core_BRCorePaymentProtocolPayment_createPaymentProtocolPayment
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_electraproject_core_BRCorePaymentProtocolPayment_disposeNative
  (JNIEnv *, jobject);
